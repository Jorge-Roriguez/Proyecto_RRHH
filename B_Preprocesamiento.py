...
# -------------------------- Exploración y conversión inicial ------------------------------------------------
...
# Limpiamos nulos de df_general  
funciones.imputar_numericas(df_general, 'most_frequent')

# Limpieza nuelos de df_retirement 
# La estrategia de limpieza para esta tabla es eliminando los registros que la razón del retiro sea echado. 
